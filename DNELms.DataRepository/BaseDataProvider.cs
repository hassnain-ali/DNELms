...
namespace DNELms.DataRepository
{
    public abstract class BaseDataProvider
    {
        ...
        /// <param name="entities">Entities for insert operation</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        public async void BulkInsertEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity
        {
            using var dataContext = CreateDataConnection(LinqToDbDataProvider);
        ...
        /// </summary>
        protected string CurrentConnectionString => EngineContext.Current.DefaultConnectionString;
