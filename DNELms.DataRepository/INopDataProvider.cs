...
namespace DNELms.DataRepository
{
    ...
    public partial interface INopDataProvider
    {
        ...
        /// <param name="entity">Entity with data to update</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        //void UpdateEntityAsync<TEntity>(TEntity entity) where TEntity : BaseEntity;
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <param name="entities">Collection of Entities</param>
        void BulkInsertEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity;
