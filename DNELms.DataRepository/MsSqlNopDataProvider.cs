...
namespace DNELms.DataRepository
{
    ...
    public partial class MsSqlNopDataProvider : BaseDataProvider, INopDataProvider
    {
        ...
        {
            string connectionString = EngineContext.Current.DefaultConnectionString;
        ...
        protected void ExecuteSqlScriptFromFile(IDNEFileProvider fileProvider, string filePath)
        {
        ...
        //    var fileProvider = EngineContext.Current.Resolve<IDNEFileProvider>();
        ...
        //public TEntity InsertEntityAsync<TEntity>(TEntity entity)
        //{
        //    throw new NotImplementedException();
        //}

        //public void UpdateEntityAsync<TEntity>(TEntity entity)
        //{
        //    throw new NotImplementedException();
        //}
